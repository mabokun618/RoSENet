...
def createConfusionMatrix(y_test,y_pred,dataset_name,model_name, plt_name):
    ...
    if dataset_name == "Trento":
        ...
        df_cm.columns = ["Grass-Pure", "Dirt-And-Sand", "Water", "Buildings", "Yellow-Curb", "Trees", "Grass-Groundsurface","Road-Materials", "Buildings’-Shadow", "Sidewalk", "ClothPanels"]
        df_cm = df_cm.rename(
            {0: "Grass-Pure", 1: "Dirt-And-Sand", 2: "Water", 3: "Buildings", 4: "Yellow-Curb", 5: "Trees",
             6: "Grass-Groundsurface", 7: "Road-Materials", 8: "Buildings’-Shadow", 9: "Sidewalk", 10: "ClothPanels"})
    ...
    plt.savefig('./' + dataset_name + '/' + model_name + '_' +str(plt_name)+'.eps', format='eps')
...
def result_reports(xtest,xtest2,ytest,name,model,modelName, iternum):
    ...
    createConfusionMatrix(ytest, y_pred,name,modelName, str(name)+'_test_'+str(iternum)+'')
